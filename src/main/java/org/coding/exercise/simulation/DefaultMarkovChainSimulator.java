    ...
    public List<DefaultMarkovChainFeature> predefinedProbabilities() {
        return Arrays.asList(
                new DefaultMarkovChainFeature("spring",
                        Arrays.asList(9, 10, 11), new ParameterRange(900D, 1100D),
                        new ParameterRange(10D, 100D), new ParameterRange(5D, 20D),
                        new double[][]{
                ...
                new DefaultMarkovChainFeature("summer",
                        Arrays.asList(12, 1, 2), new ParameterRange(900D, 1100D),
                        new ParameterRange(10D, 100D), new ParameterRange(25D, 40D),
                        new double[][]{
                                new double[]{0.55D, 0.45D, 0D},
                ...
                new DefaultMarkovChainFeature("autumn",
                        Arrays.asList(3, 4, 5), new ParameterRange(900D, 1100D),
                        new ParameterRange(10D, 100D), new ParameterRange(10D, 25D),
                        new double[][]{
                ...
                new DefaultMarkovChainFeature("winter",
                        Arrays.asList(6, 7, 8), new ParameterRange(900D, 1100D),
                        new ParameterRange(10D, 100D), new ParameterRange(-5D, 10D),
                        new double[][]{
